...
const FAQ = () => (
    <>
        ...
        <Layout>
            <PanelGroup accordion bordered style={{ marginTop: '4rem', marginLeft: 'auto', marginRight: 'auto', width: '60%' }}>
                <Panel header="Why would I need a PCB Stencil ?" style={{ textAlign: 'justify' }}>
                ...
                <Panel header="How Do I Choose My Stencil Thickness ?" style={{ textAlign: 'justify' }}>
                ...
                <Panel header="What are home base apertures and why would I need them ?" style={{ textAlign: 'justify' }}>
                ...
                <Panel header="What are Trapezoidal Apertures and why would I need them ?" style={{ textAlign: 'justify' }}>
                ...
                <Panel header="What are fiducials? Do I need them on my PCB stencil ?" style={{ textAlign: 'justify' }}>
                ...
                <Panel header="Does the nano coating get into the aperture walls ?" style={{ textAlign: 'justify' }}>
                    Yes, the coating will treat both the surface of the stencil, as well as the aperture walls.
                </Panel>
                <Panel header="Does the coating contaminate the flux ?" style={{ textAlign: 'justify' }}>
                ...
                <Panel header="How do I know if the nano coating is there ?" style={{ textAlign: 'justify' }}>
